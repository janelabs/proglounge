<div class="thumbnail span3 pull-left profile-picture">
    ...
    <div class="caption">
        ...
        <?php if ($user_info['about_me'] != '') { ?>
            <p class="<?php echo ($is_your_profile) ? "p_to_text" : "" ?>"><?php echo $user_info['about_me'] ?></p>
        <?php } else {?>
            <p class="<?php echo ($is_your_profile) ? "p_to_text" : "" ?>">I will say something about me later..</p>
        <?php } ?>
    </div>
</div>